...
of voltages \textbf{\emph{v}}\emph{(t)} and currents $\tilde{\mbox{\textbf{\emph{i}}}}(t)$

\begin{align}
\mbox{\textbf{\emph{v}}}(t) & =\begin{pmatrix}v_{x}(t) & v_{y}(t) & v_{z}(t)\end{pmatrix}^{T}\\
\tilde{\mbox{\textbf{\emph{i}}}}(t) & =\begin{pmatrix}i_{x}(t) & i_{y}(t) & i_{z}(t)\end{pmatrix}^{T}.
\end{align}
...
\mbox{\textbf{\emph{I}}}_{pq}(\tau) & =\begin{pmatrix}\left\langle i_{j}^{*}(t)i_{k}^{*}(t+\tau)\right\rangle \end{pmatrix}\\
